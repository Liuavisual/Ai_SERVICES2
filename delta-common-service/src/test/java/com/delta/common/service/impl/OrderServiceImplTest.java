...
class OrderServiceImplTest {
    ...
    void createOrder_companionNotExist_shouldThrow() {
        ...
        assertThrows(BusinessException.class,
                () -> orderService.createOrder(1L, 999L, "GAME", start, end, "测试备注", "MANUAL", null),
    ...
    void createOrder_companionDisabled_shouldThrow() {
        ...
        LocalDateTime end = start.plusHours(2);
        assertThrows(BusinessException.class,
                () -> orderService.createOrder(1L, 1L, "GAME", start, end, "测试备注", "MANUAL", null),
    ...
    void createOrder_shouldSucceed() {
        ...
        LocalDateTime start = LocalDateTime.now().plusHours(1);
        LocalDateTime end = start.plusHours(2);
        OrderVO result = orderService.createOrder(1L, 1L, "GAME", start, end, "测试备注", "MANUAL", null);
