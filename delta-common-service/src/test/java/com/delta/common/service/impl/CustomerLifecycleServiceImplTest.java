...
class CustomerLifecycleServiceImplTest {
    ...
    void setUp() throws Exception {
        setFieldValue(customerLifecycleService, "atRiskDaysThreshold", 7);
        setFieldValue(customerLifecycleService, "churnedDaysThreshold", 30);
    }
    ...
    @Test
    @DisplayName("判断生命周期阶段 - 消息数大于50且订单数>=3返回LOYAL")
